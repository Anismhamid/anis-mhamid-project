...
let checkWinner = () => {
    ...
    for (var boardId of Object.keys(boardState)) {
        ...
        for (let combination of winningCombinations) {
            ...
            if (cells[a] && cells[a] === cells[b] && cells[b] === cells[c]) {
                ...
                return {winner, boardId }// מחזיר X או O המנצח
            }
        }
    }

    return null; // אםאין מנצח
}
